...
public class MotoElectrica extends Automotor implements IVehiculoElectrico{
    ...
    public MotoElectrica(Integer idCP,Patente patente,String competencia, Persona propietario, Uso uso, String provincia, String localidad, String marca, String modelo, String anio) {
    ...
    public MotoElectrica(Integer idCP, LocalDate fechaAltaAutomotor, Patente patente, Persona propietario, LocalDate fechaCambioPropiet, Uso uso) {
        super(idCP, fechaAltaAutomotor, patente, propietario, fechaCambioPropiet, uso);
    }

    @Override
    public void indicarVoltaje() {
        System.out.println("El volateje es de 220V");
    }
}
